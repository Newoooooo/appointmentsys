        ...
        <header className="sticky top-0 z-40 h-20 bg-[#fdfcfc] dark:bg-[#141414] px-6 md:px-10 flex items-center justify-between border-b border-[#e6e4e6] dark:border-[#282828]">
            <div className="flex items-center gap-6 flex-1 max-w-xl">
                <motion.button
                    ...
                    className="p-2.5 bg-[#f4f2f4] dark:bg-[#282828] rounded-xl text-[#2f3035] dark:text-[#fdfcfc] hover:text-[#F26389] transition-colors shrink-0"
                >
            ...
            <div className="flex items-center gap-4 md:gap-8 shrink-0">
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={toggleTheme}
                    className="p-2.5 bg-[#f4f2f4] dark:bg-[#282828] rounded-xl text-[#2f3035] dark:text-[#fdfcfc] hover:text-[#F26389] transition-colors"
