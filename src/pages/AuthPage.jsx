        ...
        <div className="min-h-screen flex bg-[#fdfcfc] dark:bg-[#141414] transition-colors duration-500">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-[#2f3035] dark:bg-[#1c1c1c] p-16 flex-col justify-between relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
                    ...
                    <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] rounded-full border-[1px] border-[#f87941]" />
                </div>

                <div className="relative z-10">
                    <div className="w-14 h-14 bg-[#f87941] rounded-[20px] flex items-center justify-center text-white font-black text-2xl mb-12 shadow-2xl shadow-[#f87941]/30">
                        B
                    </div>
                ...
                <div className="relative z-10 max-w-sm">
                    <div className="h-[1px] w-12 bg-[#f87941] mb-6" />
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
                ...
                >
                    <div className="space-y-3 text-center lg:text-left">
                        <p className="text-[10px] font-black text-[#f87941] uppercase tracking-[0.4em]">Get Started</p>
                        ...
                        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                            {!isLogin && (
                                <div className="space-y-2">
                                    ...
                                    <input type="text" placeholder="The Wellness Lab" className="w-full px-5 py-4 bg-transparent rounded-2xl border border-[#e6e4e6] dark:border-[#3f3835] focus:border-[#f87941] outline-none transition-all text-[#2f3035] dark:text-[#fdfcfc]" />
                                </div>
                            )}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="email" placeholder="sarah@studio.com" className="w-full pl-14 pr-5 py-4 bg-transparent rounded-2xl border border-[#e6e4e6] dark:border-[#3f3835] focus:border-[#f87941] outline-none transition-all text-[#2f3035] dark:text-[#fdfcfc]" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between px-2">
                                    ...
                                    {isLogin && <button className="text-[10px] font-black text-[#f87941] uppercase tracking-widest">Forgot?</button>}
                                </div>
                                <div className="relative">
                                    <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-[#b1b1b1]" size={18} />
                                    <input type="password" placeholder="••••••••" className="w-full pl-14 pr-5 py-4 bg-transparent rounded-2xl border border-[#e6e4e6] dark:border-[#3f3835] focus:border-[#f87941] outline-none transition-all text-[#2f3035] dark:text-[#fdfcfc]" />
                                </div>
                            </div>

                            <button className="w-full bg-[#2f3035] dark:bg-[#f87941] text-white py-5 rounded-[24px] font-black text-[10px] uppercase tracking-[0.3em] flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-[#f87941]/10 mt-8">
                    ...
                    <p className="text-center text-[10px] font-black text-[#b1b1b1] uppercase tracking-widest">
                        ...
                        <button
                            ...
                            className="text-[#f87941] hover:underline underline-offset-4"
                        >
