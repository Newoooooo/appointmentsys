                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5">
                    {integrationModules.map((mod) => (
                        <motion.div
                            ...
                            whileHover={{ y: -4 }}
                            className="bg-white dark:bg-[#111] border border-[#f4f2f4] dark:border-white/10 rounded-[32px] p-6 flex flex-col group hover:border-[#f87941]/50 transition-all duration-300"
                        >
                            {/* Card Header */}
                            <div className="flex justify-between items-start mb-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 rounded-2xl bg-[#fdfcfc] dark:bg-[#0c0c0c] border border-[#f4f2f4] dark:border-white/10 flex items-center justify-center text-[#f87941] group-hover:scale-105 transition-transform duration-500">
                                        <mod.icon size={24} strokeWidth={2} />
                                    </div>
                                    <div>
                                        <span className="text-[8px] font-black text-[#f87941] uppercase tracking-[0.2em]">{mod.type} // {mod.id}</span>
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-6 text-[8px] font-black uppercase">
                                ...
                                <div className="bg-[#fdfcfc] dark:bg-[#0c0c0c] border border-[#f4f2f4] dark:border-white/5 rounded-xl p-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <TrendingUp size={10} className="text-[#f87941]" />
                                        <span>Optimized</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-auto pt-5 border-t border-[#f4f2f4] dark:border-white/5 flex items-center justify-between">
                                <button className="text-[9px] font-black uppercase tracking-widest text-[#b1b1b1] hover:text-[#f87941] transition-colors">
                                    Learn More
                                </button>
                                <button className={clsx(
                                    "flex items-center gap-2 px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all",
                                    mod.status === 'Connected' ? "bg-[#f4f2f4] dark:bg-white/5 text-[#b1b1b1]" : "bg-[#f87941] text-white shadow-lg shadow-[#f87941]/20"
                                )}>
                    ...
                    {/* Placeholder Add */}
                    <button className="border-2 border-dashed border-[#f4f2f4] dark:border-white/10 rounded-[32px] p-8 flex flex-col items-center justify-center gap-4 text-[#b1b1b1] hover:border-[#f87941]/50 hover:text-[#f87941] transition-all group">
